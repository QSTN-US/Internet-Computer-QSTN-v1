...
import { idlFactory } from './survey_manager.did.js';
export { idlFactory } from './survey_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SURVEY_MANAGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./survey_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the survey_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./survey_manager.did.js")._SERVICE>}
 */
export const survey_manager = createActor(canisterId);
