...
actor CrowdFundNFT {
    ...
    stable var surveyResults: [(SurveyId, SurveyResult)]       = [];
    ...
    system func preupgrade() {
        ...
        surveyResults  := db.getSurveyResultArray();
    ...
    system func postupgrade() {
        ...
        db.initializeSurveyResultMap(surveyResults);
    ...
    public shared(msg) func createSurveyResult(surveyResult: NewSurveyResult): async SurveyResult {
        db.createSurveyResult(msg.caller, surveyResult)
    };
